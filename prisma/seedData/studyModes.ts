...
export const reverseStudyModeSeedIds: Record<number, string> =
	reverseObject(studyModeSeedIds);
...
export const studyModes: Omit<StudyMode, 'id' | 'createdAt' | 'updatedAt'>[] = [
	...
	},
	{
		...
		description:
			'Given the Japanese word, self-rate your English translation. Then sometime later, given the English word, self-rate your Japanese translation.',
		type: 'recognition',
	},
	{
	...
	},
	{
		...
		description:
			'Given the English word, type the Japanese translation. Then sometime later, given the Japanese word, type the English translation.',
		type: 'production',
	},
];
